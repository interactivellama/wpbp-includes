...
wp_enqueue_style('roots_app', get_template_directory_uri() . llama_auto_version('/assets/css/style.css'), false, null);
  ...
  //wp_register_script('modernizr', get_template_directory_uri() . '/assets/js/vendor/modernizr-2.6.2.min.js', false, null, false);
	wp_register_script('roots_main', get_template_directory_uri() . llama_auto_version('/assets/js/main-ck.js'), false, null, true);
