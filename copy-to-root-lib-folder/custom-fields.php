	...
	register_field_group(array (
		...
		array (
			...
			array (
				...
				'name' => 'facebook_url',
				'type' => 'text',
				'instructions' => 'URL to Facebook Page (if enabled in theme)',
				'required' => '0',
				'default_value' => '',
				'formatting' => 'none',
			...
			array (
				...
				'name' => 'linkedin_url',
				'type' => 'text',
				'instructions' => 'URL to LinkedIn Page (if enabled in theme)',
				'required' => '0',
				'default_value' => '',
				'formatting' => 'none',
			...
			array (
				...
				'name' => 'twitter_url',
				'type' => 'text',
				'instructions' => 'URL to Twitter Page (if enabled in theme)',
				'required' => '0',
				'default_value' => '',
				'formatting' => 'none',
			...
			array (
				...
				'name' => 'tumblr_url',
				'type' => 'text',
				'instructions' => 'URL to Tumblr site (if enabled in theme)',
				'required' => '0',
				'default_value' => '',
				'formatting' => 'none',
